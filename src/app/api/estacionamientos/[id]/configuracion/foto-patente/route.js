...
import { GPS_MODES, PLATE_PHOTO_MODES } from "@/lib/offStreet/offStreetPlatePhoto.mjs";
...
export async function GET(request, { params }) {
  try {
    ...
    return NextResponse.json({ data: { ...settings, modes: PLATE_PHOTO_MODES, gpsModes: GPS_MODES } });
  } catch (error) {
