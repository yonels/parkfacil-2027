...
// Pantalla pública de autenticación real de un operador vigente. Mismo
// diseño e identidad visual que /pos/login (ParkFacil POS): reutiliza el
// mismo LoginForm y el mismo mecanismo de sesión (Supabase Auth +
// /api/auth/session con scope "pos_operator"). Es el destino al que Root
// es enviado al hacer clic en "Data Entry" — Root nunca opera el terminal
// con su propia sesión (ver src/config/navigation.js, platformAdminGateway).
// Único cambio respecto a /pos/login: el destino final tras autenticar es
// /data-entry en vez de /pos.
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <Suspense fallback={<div className="mt-8 h-72 animate-pulse rounded-2xl bg-white/10" />}>
              <LoginForm tipoAcceso="terminal" loginScope="pos_operator" defaultDestination="/data-entry" />
            </Suspense>
          </div>
        </div>
      </section>
