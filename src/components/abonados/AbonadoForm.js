    ...
    <div className="space-y-6">
      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <form className="mt-6 space-y-6" onSubmit={handleSubmit}>
          ...
          {selectedResponsable && !creatingResponsable ? <button type="button" onClick={startResponsableEdit} className="rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm font-semibold text-[#3150D8]">Editar responsable</button> : null}
